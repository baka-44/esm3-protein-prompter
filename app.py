...
# ════════════════════════════════════════════════════════════════════════════════
# Pipeline functions — must be defined before the layout code calls them
# ════════════════════════════════════════════════════════════════════════════════
...
def _build_and_generate(spec, pdb_bytes: bytes | None, settings: dict):
    """Build ESMProtein → ESM3 generation → ESM2 scoring → ranked results."""
...
def _store_round(candidates, spec, round_num: int, user_prompt: str, refined_from: int | None):
